...
public:
    ...
    void init(const std::string& srcDir,std::string& path,bool isKeepAlive=false,std::string posttype="",std::string d="",int code=-1,int t=1);
...
private:
    ...
    int code_;
    bool isKeepAlive_;
    // std::string post_datakey,post_datav;
    std::string data;
