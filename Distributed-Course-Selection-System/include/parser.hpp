    ...
    */
    ...
    /*
        ...
        @return the string parsered from message
            e.g. CS06142 <- $7\r\nCS06142\r\n
    */
    string parseStringMessage(char * message, int * length=NULL);
    ...
    /*
        ...
        @return the interger parsered from message
            e.g. 10 <- :10\r\n
    */
    int parserIntergerMessage(char * message, int * length=NULL);
    ...
    /*
        ...
        @return the status of the excution
            e.g. +OK\r\n -> true
                 -ERROR\r\n -> false
    */
    bool parserSuccessMessage(char * message, int * length=NULL);
    ...
    /*
        ...
        @return the string vector parsered from message
            e.g. Cloud Computing <- *2\r\n$5\r\nCloud\r\n$9\r\nComputing\r\n
    */
    void parserRESPArry(char * message, vector<string> & rc, int * length=NULL);
